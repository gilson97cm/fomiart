<div class="parallax-container section" data-parallax-img="{{asset('assets-client/images/bg-02-1920x748.jpg')}}">
    <div class="parallax-content section-98 section-lg-124 context-dark">
        <div class="container">
            ...
            <div class="row justify-content-sm-center offset-top-66">
                ...
                @foreach($commentList as $data)
                    <div class="col-sm-10 col-md-7 col-lg-4 {{$count = 0 ? 'offset-top-50 offset-lg-top-0':''}}">
                        <!-- Boxed Testimonials-->
                        <blockquote class="quote quote-classic quote-classic-boxed">
                            <div class="quote-body bg-white text-darker">
                                <p>
                                    <q>{{Illuminate\Support\Str::limit($data->message,300)}}</q>
                                </p>
                                <div class="quote-meta">
                                    <div id="profileImage" class="rounded-circle quote-img" style="background: {{$data->bgProfile}}">
                                        {{$data->profile}}
                                    </div>
                                </div>
                            </div>
                            <h6 class="quote-author text-uppercase font-weight-bold font-default">
