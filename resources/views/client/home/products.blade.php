...
<section class="section novi-background section-98 section-lg-124">
    <div class="container">
        <h1 class="text-primary font-weight-bold">Productos</h1>
        ...
        <div class="row justify-content-sm-center offset-top-66">
            ...
            @foreach($productsList as $data)
                <div class="col-sm-10 col-md-6 col-lg-3 {{$count > 0 ? 'offset-top-50 offset-md-top-0' : ''}}">
                    <!-- Thumbnail Terry-->
                    <figure class="thumbnail-terry"><a href="#"><img width="270" height="360" src="{{asset($data->urlImage)}}" alt=""/></a>
                        <figcaption>
                            <div>
