...
<section class="section novi-background section-98 section-lg-124 bg-lightest">
    <div class="container">
        <h1 class="text-primary font-weight-bold">Servicios</h1>
        ...
        <div class="row justify-content-sm-center">
            <div class="cell xs-10 col-md-8">
                <p>Revisa aqui los servicios que ofrecemos.</p>
            </div>
        </div>
        <div class="row justify-content-sm-center offset-top-66">
            ...
            @foreach($servicesList as $data)
                ...
                <div class="col-md-4 {{$count > 0 ? 'offset-top-50 offset-md-top-0' : ''}}" >
