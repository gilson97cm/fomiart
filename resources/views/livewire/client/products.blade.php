<div>
    ...
    <section class="section novi-background section-98 section-lg-124">
        <div class="container">
            <h1 class="text-primary font-weight-bold">Conoce Todos Nuestros Productos</h1>
            ...
            <div class="row justify-content-sm-center">
                <div class="col-sm-10 col-md-8">
                    <p>Revisa aquí nuestros productos disponibles.</p>
                </div>
            </div>
            <div class="row">
                <!-- Isotope Filters-->
                <div class="col-xl-3">
                    <div class="isotope-filters isotope-filters-vertical">
                        <h4 class="text-uppercase font-weight-bold isotope-filters-title offset-top-34 font-default">Categorías</h4>
                        <ul class="list-inline list-inline-sm">
                            <li class="list-inline-item d-lg-none">
                                <p>Elige tu categoría:</p>
                            </li>
                            <li class="list-inline-item section-relative">
                                <button class="isotope-filters-toggle btn btn-sm btn-default" >Filtrar<span class="caret"></span></button>
                                <ul class="list-sm-inline isotope-filters-list" id="isotope-1">
                                    <li wire:click="setCategoryId('')"><a class="font-weight-bold {{$category_id == '' ? 'active' : ''}}" >Todo</a></li>
                                    @foreach($categoriesList as $data)
                                    <li wire:click="setCategoryId({{$data->id}})">
                                        <a class="font-weight-bold {{$category_id == $data->id ? 'active' : ''}}">
                                            {{$data->name}}
                                        </a>
                                    </li>
                                    @endforeach
                ...
                <div class="col-xl-9 ">
                    <div class="row justify-content-sm-center offset-top-66">
                        ...
                        @foreach($productsList as $data)
                            <div class="mb-4 col-12 col-md-6 col-lg-4 {{$count > 0 ? 'offset-top-50 offset-md-top-0' : ''}}">
                                <!-- Thumbnail Terry-->
                                <figure class="thumbnail-terry">
                                    <a href="#">
                                        <img width="270"
                                             height="360"
                                             src="{{asset($data->urlImage)}}" alt=""/>
                                    </a>
                                    <figcaption>
                                        <div>
                                            <h4 class="thumbnail-terry-title">{{$data->name}}</h4>
                                        </div>
                                        <p class="thumbnail-terry-desc offset-top-0"></p>
                                        <a class="btn offset-top-10 offset-md-top-0 btn-safety-orange" href="{{route('productDetails',$data->id)}}">
                                            Leer Más
                                        </a>
                                    </figcaption>
                                </figure>
