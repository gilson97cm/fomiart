...
<!-- Welcome to Intense-->
    <section class="section novi-background section-98 section-md-124">
        <div class="container">
            <div class="row grid-group-md offset-top-0 justify-content-center">
                <div class="col-sm-10 col-lg-6 text-lg-left inset-lg-right-80">
                    <h1 class="font-weight-bold text-primary">Bienvenido a FomiArt</h1>
                    <div class="offset-top-30 offset-lg-top-50">
                        <p>{{$pagesData->abstract}}</p>
                    </div>
                    <div class="offset-top-20 offset-lg-top-30">
                        <a class="btn btn-safety-orange" href="{{route('aboutUsHome')}}">Leer Más</a>
                    </div>
                </div>
                <div class="col-sm-10 col-lg-6">
                    <img class="img-fluid d-inline-block" src="{{asset($pagesData->urlImage)}}" width="570" height="320"
                         alt="">
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row justify-content-sm-center offset-top-66">
                ...
                <div class="col-sm-10 col-md-7 col-lg-4 offset-top-50 offset-lg-top-0">
                    ...
                    <div class="unit unit-md flex-lg-row text-lg-left">
                        <div class="unit-left"><span
                                class="novi-icon icon icon-lg icon-outlined mdi mdi-cash-register text-safety-orange"></span>
                        </div>
                        <div class="unit-body">
                            <h4 class="font-weight-bold font-default text-uppercase font-weight-bold offset-md-top-20">
                                Ventas</h4>
                            <p>Ventas al por mayor y menor de: Textos en fomix, MDF y vinil.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    @include('client/home/products')
    @include('client/home/services')
    @include('client/home/comments')
    @include('client/home/gallery')
</div>
